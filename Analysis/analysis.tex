...
\begin{figure}[H]
    ...
    \caption{This is the Standing Order Form. This is printed and handed to the user along with the membership form and is used mainly for details regarding the payment spreadsheet as well as getting the members bank account number and sort code for payments.} \label{fig:Standing Order Form }
\end{figure}
