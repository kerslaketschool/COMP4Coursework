...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{Prelim Designs.jpg}
...
Command Line Application Programmed in Python
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Uses a database that will be easily understandable when compared to the previous excel spreadsheets
	\end{itemize}
	\item Disadvantages
	\begin{itemize}
...
My Chosen solution is too use an application with a GUI programmed in python with the library PyQt. This is because of a number of reasons:
...
\begin{itemize}
    ...
    \item Python is easy to install and I can easily guide my client and hs staff in open the application
    \item If its more accessable to the client I can even make an executable of the program using a program like cx freeze
    \item Programming in python gives me the opportunity to present and demontrate my knowledge of complex programing features like Object Oriented Programming and recursive programming
